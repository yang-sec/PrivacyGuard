...
contract DistributeFund_2 {
    
    address [32] public accounts = [
        0x154f3d575f404544f65aace4f3cb462f652a4185, // 129
        ...
        0x7ed00465e851440597acd7bac5da8c96cbe91b19 // 160
    ];
    ...
    function distribute(uint value) public {
        for(uint i = 0; i < 32; i++) {
